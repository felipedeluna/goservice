...
public class ClienteController {
    ...
    public ModelAndView dados(Authentication authentication) {
        ...
        try {
            ...
            mv.addObject("errorMessage", "Erro ao carregar as informações do usuário.");
        }
        return mv;
    }
    ...
    public String alterarDados(Cliente cliente, RedirectAttributes attributes){
        try {
            ...
            attributes.addFlashAttribute("errorMessage", "Erro ao alterar os dados do usuário.");
        }
    ...
    public String criarAgendamento(
        ...
        try {
            ...
            attributes.addFlashAttribute("successMessage", "Agendamento realizado com sucesso!");
    ...
    public String concluirAgendamento(
        ...
        try {
            ...
            attributes.addFlashAttribute("successMessage", "Agendamento concluído com sucesso!");
        } catch (UsuarioNaoAutenticadoException |
                 UsuarioNaoEncontradoException |
                 ServicoNaoEncontradoException |
                 StatusAgendamentoImutavelException ex){
